...
//                template.process(attributes, fileWriter);
                ...
                for (Element elementIn : element.getEnclosedElements()) {
                    ...
                    if (inputAnnotation != null) {
                        writer.write("<input ");
                        if (inputAnnotation.type() != null)
                            writer.write("type= '" + inputAnnotation.type() + "' ");
                        if (inputAnnotation.name() != null)
                            writer.write("name= '" + inputAnnotation.name() + "' ");
                        if (inputAnnotation.placeholder() != null)
                            writer.write("placeholder= '" + inputAnnotation.placeholder() + "' ");
                        writer.write(">");
                    }
                }
                writer.close();
